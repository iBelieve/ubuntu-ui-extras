...
ShaderEffect {
    ...
    property color inputColor: Theme.palette.normal.baseText
...
//        }"
    ...
    fragmentShader: "
        ...
        void main() {
            ...
            gl_FragColor = mix(vec4(outputColor.rgb, 1.0) * sourceColor.a, sourceColor, step(threshold, distance(sourceColor.rgb / sourceColor.a, inputColor.rgb))) * qt_Opacity;
        }"
}
