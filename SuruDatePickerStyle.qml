...
Item {
    ...
    /*!
      ...
      */
    property color backgroundColor: Qt.rgba(0.5,0.5,0.5,0.4)
    /*!
      Background color for highlight.
      */
    property color highlightBackgroundColor: "#dd4814"//"#ffffffff"
    /*!
      Highlight color.
      */
    property color highlightColor: Theme.palette.normal.baseText//UbuntuColors.orange
    /*!
    ...
    Rectangle {
        ...
        ShaderEffectSource {
            id: effectSource
            visible: false
            sourceItem: view//findChild(view, "PickerRow_Positioner") // FIXME: Nasty hack
